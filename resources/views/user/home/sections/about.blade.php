...
<section class="home-section">
    <div class="container">
        <div class="row about-sec-tag-row">
            <div class="col-12 text-center about-sec-tag-wrap sr">
                <span class="sec-tag d-block mb-0">Lời nhắn đầu tiên</span>
            </div>
        </div>

        <div class="row align-items-center g-4 g-lg-5 about-row">
            <div class="col-lg-6 about-img-wrap sr sr-left sr-blur-in order-1 order-lg-1">
          ...
          <img src="{{ asset('/user/demo.jpg') }}?t=190x190/ecdacf/b07d62?text=Award" alt="Award">
            ...
            <div class="col-lg-6 about-content sr sr-right d1 sr-flip order-2 order-lg-2">
