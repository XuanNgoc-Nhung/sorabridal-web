...
@section('title', 'Information | Sorabridal')

@section('content') 
    <div class="ready banner-padding bg-img" data-overlay-light="0" data-background="user/images/banner/5.jpg" style="background-image: url(&quot;user/images/banner/5.jpg&quot;);">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
    ...
    <div class="section-padding prices">
        <div class="container">
            ...
            <div class="row mb-60">
                <div class="col-md-4">
                    <div class="item">
                        <div class="prices-img"> <img src="user/images/information/1.jpg" alt="">
                            <div class="cat">
                ...
                <div class="col-md-4">
                    <div class="item">
                        <div class="prices-img"> <img src="user/images/information/2.jpg" alt="">
                            <div class="cat">
                ...
                <div class="col-md-4">
                    <div class="item">
                        <div class="prices-img"> <img src="user/images/information/3.jpg" alt="">
                            <div class="cat">
